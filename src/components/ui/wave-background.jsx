...
export function Waves({
    className = "",
    strokeColor = "rgba(59, 130, 246, 0.4)", // Blue neon stroke
    backgroundColor = "transparent", // Let the background container decide the color
    pointerSize = 0.5
}) {
    ...
    const setLines = () => {
        ...
        const xGap = 10  // Reduced horizontal spacing
        const yGap = 10  // Reduced vertical spacing for denser points
